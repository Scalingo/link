...
type FiltersTag struct {
	...
	// The resource type (`customer-gateway` \\| `dhcpoptions` \\| `image` \\| `instance` \\| `keypair` \\| `natgateway` \\| `network-interface` \\| `public-ip` \\| `route-table` \\| `security-group` \\| `snapshot` \\| `subnet` \\| `task` \\| `virtual-private-gateway` \\| `volume` \\| `vpc` \\| `vpc-endpoint` \\| `vpc-peering-connection`\\| `vpn-connection`).
